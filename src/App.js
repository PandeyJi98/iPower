        ...
        <Router basename="/iPower">
            <Suspense fallback={<SpinnerExample />}>
                ...
                <Routes>
                    ...
                    <Route exact sensitive={false} path={('/cycling-challenge').toLowerCase()} element={<WebDesigning />}></Route>
                    <Route exact path="/run-challenge" element={<WebDevelopment />}></Route>
                    <Route exact path="/walk-challenge" element={<AppDevelopment />}></Route>
