            ...
            <div className="container pb-lg-5 mt-4 p-30" >
                ...
                <div className="row" >
                    <div className="col-12 col-md-6 col-xl-3 mb-5 mb-md-5 mb-xl-0 " data-aos="zoom-out-up">
                        <div className="card m-auto h-100 " >
                            <img src={cycleImage} className="card-img-top" loading='lazy' alt="web designing" title="web designing" height="210" width="210" />
                    ...
                    <div className="col-12 col-md-6 col-xl-3 mb-5 mb-md-5 mb-xl-0" data-aos="zoom-out-down">
                        <div className="card m-auto h-100">
                            <img src={runChallengeIms} className="card-img-top" loading='lazy' alt="iPower" title='Web Development' height="210" width="210" />
                            <div className="card-body">
                    ...
                    <div className="col-12 col-md-6 col-xl-3 mb-5 mb-md-5 mb-xl-0" data-aos="zoom-out-left">
                        <div className="card m-auto h-100">
                            <img src={walkImage} className="card-img-top" loading='lazy' alt="iPower" title="iPower" height="210" width="210" />
                            <div className="card-body">
                ...
                <div className="row mt-lg-5">
                    ...
                    <div className="col-12 col-md-6 col-xl-3 mb-5 mb-md-5 mb-xl-0" data-aos="zoom-in-up">
                        <div className="card m-auto h-100">
                            <img src={plant} className="card-img-top" loading='lazy' alt="Business Analysis" title='Business Analysis' height="210" width="210" />
                            <div className="card-body">
                    ...
                    <div className="col-12 col-md-6 col-xl-3 mb-5 mb-xl-0" data-aos="zoom-in-down">
                        <div className="card m-auto h-100">
                            <img src={tripChallenge} className="card-img-top" loading='lazy' alt="Social Marketing Media" title='Social Marketing Media' height="210" width="210" />
                            <div className="card-body">
                    ...
                    <div className="col-12 col-md-6 col-xl-3 mb-md-5 mb-xl-0" data-aos="zoom-in-left">
                        <div className="card m-auto h-100">
                            <img src={swimming} className="card-img-top" loading='lazy' alt="App Development" title='App Development' height="210" width="210" />
                            <div className="card-body">
